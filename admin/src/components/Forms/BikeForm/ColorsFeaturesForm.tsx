...
export default function ColorsFeaturesForm({ bikeId }: { bikeId: string | Blob | null, onTabChange: (tab: number) => void }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        formData.append("bikeId", bikeId as string)
        const res = await addBikeOthers({ formData })
