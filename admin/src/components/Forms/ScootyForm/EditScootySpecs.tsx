...
const EditScootySpecs = ({ scootyId, editDimensions, editEngine, editTransmission, editTyresAndBrakes, editFrameAndSuspension, editElectronics, onTabChange }: { scootyId: string, editDimensions: BodyDimensions, editEngine: Engine, editTransmission: Transmission, editTyresAndBrakes: TyresAndBrakes, editFrameAndSuspension: FrameAndSuspension, editElectronics: Electronics, onTabChange: (tab: number) => void }) => {
...
export default EditScootySpecs
