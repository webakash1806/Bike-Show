...
import { useAddScootySpecsMutation } from '../../../Redux/API/ScootyApi';
...
const AddScootySpecs = ({ scootyId, onTabChange }: { scootyId: string | Blob | null, onTabChange: (tab: number) => void }) => {
    console.log(scootyId)
    const [addScootySpecs, { isLoading }] = useAddScootySpecsMutation()
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const response = await addScootySpecs({ specs }) as { data: ResponseData }
    ...
    const items = [
        {
            ...
            content:
                <div className="relative pt-2 sm:pt-2 w-full mx-auto mb-10 space-y-4 overflow-hidden   bg-[#fffefe] rounded-t-md">
            ...
            content:
                <div className="relative    pt-2 sm:pt-2 w-full mx-auto mb-10 space-y-4 overflow-hidden   bg-[#fffefe] rounded-t-md">
                    ...
                    <div className="grid grid-cols-1 gap-2 sm:gap-4 sm:grid-cols-3">
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="airFilterType" className=" text-[0.85rem]">
                                Air Filter Type <span className="text-red-600">*</span>
                            </Label>
                            <Input name="airFilterType" onChange={handleEngineChange} value={engine?.airFilterType} id="airFilterType" placeholder="Enter air filter type..." type="text" required className="py-[0.65rem]" />
                        </div>
                        <div className="space-y-1">
        ...
        },
        {
            ...
            content:
                <div className="relative    pt-2 sm:pt-2 w-full mx-auto mb-10 space-y-4 overflow-hidden bg-[#fffefe] rounded-t-md">
                    ...
                    <div className="grid grid-cols-1 gap-2 pb-4 border-b sm:gap-4 sm:grid-cols-3">
                        <div className="space-y-1">
                            <Label htmlFor="tyreType" className=" text-[0.85rem]">
                                Tyre type <span className="text-red-600">*</span>
                            </Label>
                            <Input name="tyreType" onChange={handleTyresAndBrakesChange} value={tyresAndBrakes?.tyreType} id="tyreType" placeholder="Enter tyre type..." type="text" required className="py-[0.65rem]" />
                        </div>
                        <div className="space-y-1">
    ...
    return (
        <div className="relative w-[94vw] sm:w-[96vw]  p-4 sm:p-6  pt-2 sm:pt-2 sm:max-w-[50rem] max-w-[28rem] mx-auto mb-10 space-y-4 overflow-hidden rounded-t shadow-lg bg-[#fffefe] rounded-md">
            ...
            <button onClick={handleSubmit} className="relative mb-4 w-full font-semibold flex items-center justify-center px-4 gap-3 py-2.5 text-sm text-white transition duration-200 bg-red-600 rounded-md top-2">
                Add Specs <FaForward />
            </button>
        </div>
    )
