...
import { useGetBikeQuery } from "@/Redux/AllApi/BikeApi";
...
const BikePreview = () => {
    ...
    const { data: bikeData } = useGetBikeQuery(id);
    ...
    const [activeImage, setActiveImage] = useState(bikeData?.bike?.image?.url);
    ...
    return (
        <HomeLayout>
            <div className="min-h-screen p-1 pt-0 pb-20 sm:p-6 sm:pt-0">
                <div className="pt-3 overflow-hidden">
                    <div className="relative min-h-[80vh]  bg-neutral-900 rounded-lg shadow-lg">

                        <Tabs defaultValue="tab-1" className="relative top-0 right-0 z-50 w-full h-full">
                            <ScrollArea className="p-0.5 mx-auto z-[70] bg-neutral-800 rounded-lg -top-2 w-fit">
                                <TabsList className="p-[0.18rem]">
                                    ...
                                    {bikeData?.bike?.features?.length > 0 && (
                                ...
                                <div className="relative z-40 flex flex-col items-center justify-around gap-4 min-h-[22rem] sm:min-h-[25rem] lg:flex-row pb-10">
                                    <div className="flex sm:flex-row flex-col-reverse  items-center   max-h-[25rem]  h-full justify-center p-6  md:gap-4 w-[99%] sm:w-[95%] lg:w-[45%]">
                                        <div className="flex flex-row gap-2 sm:flex-col">
                                            {bikeData?.bike?.colors?.map((color, index) => (
                                                <motion.div
                                                    key={index}
                                        ...
                                        >
                                            ...
                                            <motion.img
                                                src={activeImage || bikeData?.bike?.image?.url}
                                                alt={bikeData?.bike?.name}
                                            ...
                                            {hovered && (
                                                <div
                                                    ...
                                                    style={{
                                                        backgroundImage: `url(${activeImage || bikeData?.bike?.image?.url})`,
                                                        backgroundSize: "650%",
                                    ...
                                    <div className="text-white w-[95%]  sm:w-[95%] lg:w-[45%]">
                                        <h1 data-aos="fade-up" data-aos-duration="300" className="mb-2 text-3xl font-bold ">
                                            {bikeData?.bike?.name}
                                        </h1>
                                        <p data-aos="fade-up" data-aos-duration="500" className="mb-4 text-xl ">₹{bikeData?.bike?.price?.toLocaleString("en-In")}</p>
                                        <p data-aos="fade-up" data-aos-duration="700" className="">{bikeData?.bike?.description}</p>
                                    ...
                                    <div className="text-white w-[99%]  sm:w-[95%] lg:w-[40%]">
                                        <Tabs defaultValue="tab-1">
                                            ...
                                            <TabsContent data-aos="zoom-in-up" data-aos-duration="800" value="tab-1" className="border rounded-md shadow-md border-red-900/20">
                                                <Table className="overflow-hidden rounded-md shadow">
                                                    <TableBody className="overflow-hidden rounded-md">
                                                        {bikeData?.bike?.specification?.bodyDimensions && (
                                                            Object.entries(bikeData?.bike?.specification?.bodyDimensions || {}).map(([key, value]) => {
                                            ...
                                            <TabsContent data-aos="zoom-in-up" data-aos-duration="800" value="tab-2" className="border rounded-md shadow-md border-red-900/20 shadow-red-500/50">
                                                <Table className="overflow-hidden rounded-md shadow">
                                                    <TableBody className="overflow-hidden rounded-md">
                                                        {bikeData?.bike?.specification?.engine && (
                                                            Object.entries(bikeData?.bike?.specification?.engine || {}).map(([key, value]) => {
                                                                const valueString = value === null || value === undefined ? "" : String(value);
                                                                return (
                                                                    valueString &&
                                                                    <TableRow key={key} className=" hover:bg-transparent [&>:not(:last-child)]:border-r *:border-gray-800">
                                            ...
                                            <TabsContent data-aos="zoom-in-up" data-aos-duration="800" value="tab-3" className="border rounded-md shadow-md border-red-900/20 shadow-red-500/50">
                                                <Table className="overflow-hidden rounded-md shadow">
                                                    <TableBody className="overflow-hidden rounded-md">
                                                        {bikeData?.bike?.specification?.transmission && (
                                                            Object.entries(bikeData?.bike?.specification?.transmission || {}).map(([key, value]) => {
                                                                const valueString = value === null || value === undefined ? "" : String(value);
                                                                return (
                                                                    valueString &&
                                                                    <TableRow key={key} className=" hover:bg-transparent [&>:not(:last-child)]:border-r *:border-gray-800">
                                            ...
                                            <TabsContent data-aos="zoom-in-up" data-aos-duration="800" value="tab-4" className="border rounded-md shadow-md border-red-900/20 shadow-red-500/50">
                                                <Table className="overflow-hidden rounded-md shadow">
                                                    <TableBody className="overflow-hidden rounded-md">
                                                        {bikeData?.bike?.specification?.frameAndSuspension && (
                                                            Object.entries(bikeData?.bike?.specification?.frameAndSuspension || {}).map(([key, value]) => {
                                                                const valueString = value === null || value === undefined ? "" : String(value);
                                                                return (
                                                                    valueString &&
                                                                    <TableRow key={key} className=" hover:bg-transparent [&>:not(:last-child)]:border-r *:border-gray-800">
                                            ...
                                            <TabsContent data-aos="zoom-in-up" data-aos-duration="800" value="tab-5" className="border rounded-md shadow-md border-red-900/20 shadow-red-500/50">
                                                <Table className="overflow-hidden rounded-md shadow">
                                                    <TableBody className="overflow-hidden rounded-md">
                                                        {bikeData?.bike?.specification?.tyresAndBrakes && (
                                                            Object.entries(bikeData?.bike?.specification?.tyresAndBrakes || {}).map(([key, value]) => {
                                                                const valueString = value === null || value === undefined ? "" : String(value);
                                                                return (
                                                                    valueString &&
                                                                    <TableRow key={key} className=" hover:bg-transparent [&>:not(:last-child)]:border-r *:border-gray-800">
                                            ...
                                            <TabsContent data-aos="zoom-in-up" data-aos-duration="800" value="tab-6" className="border rounded-md shadow-md border-red-900/20 shadow-red-500/50">
                                                <Table className="overflow-hidden rounded-md shadow">
                                                    <TableBody className="overflow-hidden rounded-md">
                                                        {bikeData?.bike?.specification?.electronics && (
                                                            Object.entries(bikeData?.bike?.specification?.electronics || {}).map(([key, value]) => {
                                                                const valueString = value === null || value === undefined ? "" : String(value);
                                                                return (
                                                                    valueString &&
                                                                    <TableRow key={key} className=" hover:bg-transparent [&>:not(:last-child)]:border-r *:border-gray-800">
                            ...
                            <TabsContent value="tab-3">
                                <div className="p-4 pt-12 text-xs text-center text-gray-400 lg:pt-16">
                                    <h1 className="mb-8 text-3xl font-semibold text-white">{bikeData?.bike?.name} - {bikeData?.bike?.model}</h1>
                                    <Swiper ref={nextRef}
                                        effect={"coverflow"}
                                        grabCursor={true}
                                        centeredSlides={true}
                                    ...
                                    >
                                        {bikeData?.bike?.features?.map((movie, index) => (
                                            <SwiperSlide
                                                key={index}
                            ...
                            <TabsContent value="tab-4">
                                <div className="relative z-40 flex flex-col items-center justify-around gap-4 min-h-[22rem] sm:min-h-[25rem] lg:flex-row pb-10">
                                    ...
                                    <div className="text-white pb-10 p-4 border rounded-md bg-[#111111] border-neutral-700 w-[99%]  sm:w-[95%] lg:w-[45%]">
                                        ...
                                        <MyReCaptchaProvider>
                                            <EnquiryForm vehicleType={"Bike"} model={bikeData?.bike?._id} />
                                        </MyReCaptchaProvider>
                                    </div>
                                </div>
                            </TabsContent>
